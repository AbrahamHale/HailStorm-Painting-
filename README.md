...
Plain static HTML site for Heritage Painting & Renewal (heritagepaintco.com, once the
...
1. Go to web3forms.com, enter **info@heritagepaintco.com**, and it emails
   you an **access key**.
...
## When you buy heritagepaintco.com

1. In Cloudflare Pages: your project → **Custom domains → Set up a custom
   domain** → enter `heritagepaintco.com` and follow the DNS steps it
